...
@Component({
  selector: 'app-registro-inge-screen',
  templateUrl: './registro-inge-screen.component.html',
  styleUrls: ['./registro-inge-screen.component.scss']
})
export class RegistroIngeScreenComponent implements OnInit {
  ...
  public registrar(){
    ...
    this.errors = this.usuariosService.validarUsuario(this.user, this.editar);    if(!$.isEmptyObject(this.errors)){
